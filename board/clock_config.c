...
- {id: CLK16K3_toMAIN_clock.outFreq, value: 16.384 kHz}
- {id: CLK_144M_clock.outFreq, value: 144 MHz}
- {id: CLK_48M_clock.outFreq, value: 48 MHz}
- {id: CMP2FDIV_clock.outFreq, value: 12 MHz}
...
- {id: CLK16K3_MAIN_EN, value: Enabled}
- {id: CMP2FCLKDIV_HALT, value: Enable}
...
- {id: SYSCON.CMP2FCLKSEL.sel, value: SCG.FRO_12M}
...
void BOARD_BootClockPLL150M(void)
{
    ...
    CLOCK_SetupClk16KClocking(kCLOCK_Clk16KToMain);      /* FRO16 kHz output clock to Main enabled */
    ...
    CLOCK_AttachClk(kFRO12M_to_CMP2F);                 /*!< Switch CMP2F to FRO12M */
    ...
    CLOCK_SetClkDiv(kCLOCK_DivCmp2FClk, 1U);           /*!< Set CMP2FCLKDIV divider to value 1 */
